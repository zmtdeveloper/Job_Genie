...
export default function CareerChatLoading() {
  return (
    <div className="space-y-6 px-4 md:px-1 lg:h-full lg:min-h-0 lg:overflow-hidden">
      <Card className="chatbot-inset-panel overflow-hidden border-0 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white shadow-none">
      ...
      <div className="grid gap-5 xl:grid-cols-[300px_minmax(0,1fr)_320px]">
        <Card className="chatbot-inset-panel min-h-[720px] shadow-none">
